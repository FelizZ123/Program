...
void loop() {
  ...
  if (Udp.available())
  {
    ...
    String Fan = String(packetBuffer[0]) + String(packetBuffer[1]) + String(packetBuffer[2]);
    String Heater = String(packetBuffer[3]) + String(packetBuffer[4]) + String(packetBuffer[5]);
    String Light = String(packetBuffer[6])+String(packetBuffer[7])+String(packetBuffer[8]);
    String Mist = String(packetBuffer[9]);
if(Mist == "1")
{
  State = "ON" ;
}
else
{
  State = "OFF" ;
    ...
    do {
      ...
      // HUMI ===========
      PrintOLED_Size2(1, 1, "Fan:       ");
      PrintOLED_Size2(5, 1, Fan);
      // TEMP ===========
      PrintOLED_Size2(1, 2, "Heater:       ");
      PrintOLED_Size2(9, 2, Heater);
      // LIGHT ===========
      PrintOLED_Size2(1, 3, "Light:    ");
      PrintOLED_Size2(8, 3, Light);
      // MIST
      PrintOLED_Size2(1, 4, "Mist Pump:    ");
      PrintOLED_Size2(12, 4, State);
